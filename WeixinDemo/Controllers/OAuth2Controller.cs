...
namespace WeixinDemo.Controllers
{
    public class OAuth2Controller : Controller
    {
        ...
        {
            //此页面引导用户点击授权
            ViewData["UrlUserInfo"] = OAuthApi.GetAuthorizeUrl(appId, userInfoRedirectUrl, "STATE", OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] = OAuthApi.GetAuthorizeUrl(appId, baseRedirectUrl, "STATE", OAuthScope.snsapi_base);
