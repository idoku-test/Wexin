...
using WeixinDemo.Service.MessageHandlers;
...
namespace WeixinDemo.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Post(PostModel postModel)
        {
            ...
            try
            {
                messageHandler.RequestDocument.Save(Path.Combine(logPath, string.Format("{0}_Request_{1}.txt",
                    _getRandomFileName(), messageHandler.RequestMessage.FromUserName)));
